...
export class Notice extends Component {
    ...
    return (
      <React.Fragment>
        <div class="col-lg-12 col-md-12 text-page-content">
          ...
          {HtmlReactParser(notice.noticeContent)}
  ...
  render() {
    let notice = this.state.loading ? <p className="text-center">Loading...</p> : Notice.renderNotice(this.state.notice.noticeItem);

    let bottoms = this.state.loading ? <p className="text-center">Loading...</p> : Notice.renderBottom(this.state.notice.bottomItem);
